...
export default async function SpectateHomePage() {
	...
	return (
		<main className="min-h-screen bg-gradient-to-b from-background via-background to-muted/30 px-4 py-16">
			<div className="mx-auto flex w-full max-w-5xl flex-col gap-10">
				<header className="space-y-3 text-center">
					...
					<p className="text-base text-muted-foreground sm:text-lg">
						Watch ongoing matches in real time. Pick a game below to jump into
						the action.
					</p>
				</header>
				{games.length === 0 ? (
